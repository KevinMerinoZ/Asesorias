    ...
    <br>
        <div class="row d-flex justify-content-center">
            <div class="col-md-8 p-0 contenedor-accion">
                <h2> Gestion de Directivos </h2>

                <div class="contenedor-accion-cuerpo">
                    <form name="frm-busquedaDirectivo" action="" method="POST">
                        <label for="matricula" class="label-body">
                            <b>Matricula:</b> <br>
                            <input type="text" name="matricula" required>
                        </label>
                        <button type="submit" name="opc" value="consultarUnDirectivo" class="boton-primario" >Buscar</button>
                    </form>
                    <br>
                    <div class="contenedor-tabla">
                        <table class="table tabla">
                            ...
                            <tbody class="table-group-divider">
                                ...
                                <form name="frm-gestionDirectivo-<?= $rows['matricula'] ?>" id="frm-gestionDirectivo-<?= $rows['matricula'] ?>" action="" method="POST" onsubmit="return confirmacionAccion()">
                                    <tr>
                                        ...
                                        <td> 
                                            <div class="columna-acciones">
                                                ...
                                                <button form="frm-gestionDirectivo-<?= $rows['matricula'] ?>" class="boton-icono" type="submit" name="opc" value="eliminarDirectivo">
                    ...
                    <button class="boton-primario" data-bs-toggle="modal" data-bs-target="#modalCrearDirectivo"> Crear </button>

                    <!-- Modal -->
                    <?php require_once("View/Users/Directivo/Gestiones/Modales/modalCrearDirectivo.php"); ?>
                </div>
            </div>
        </div>
    </div>
