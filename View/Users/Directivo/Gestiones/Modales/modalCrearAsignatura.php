            ...
            <div class="modal-body modal-cuerpo">
                <form name="frm-crear-asignatura" id="frm-crear-asignatura" action="" method="POST">
                    ...
                    <div>
                        <label for="nombre">
                            Nombre: <br>
                            <input type="text" name="nombre" id="nombre" placeholder="Nombre de la Asignatura" required>
                        </label>
                    </div>
                    <br>
                    <div>
                        <label for="siglas">
                            Siglas: <br>
                            <input type="text" name="siglas" id="siglas" placeholder="Siglas de la Asignatura" required>
                        </label>
                    </div>
                    <br>
                    <div>
                        <label for="descripcion">
                            Descripción: <br>
                            <textarea name="descripcion" id="descripcion" placeholder="Descripción de la Asignatura" required></textarea>
                        </label>
                    </div>
