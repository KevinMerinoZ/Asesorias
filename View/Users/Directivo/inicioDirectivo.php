    ...
    <form name="frmAccion" action="" method="POST" class="container">
        ...
        <div class="col-md-6 p-0 contenedor-accion">
            ...
            <div class="d-flex justify-content-between"> 
                <button type="submit" name="opc" value="respaldo" class="boton-primario">Respaldar</button>
                <button type="submit" name="opc" value="restaurar" class="boton-primario">Restaurar</button>
            </div>
