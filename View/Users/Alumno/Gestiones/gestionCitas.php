                            ...
                            <tbody class="table-group-divider">
                                ...
                                <form name="frm-gestionCitas-<?= $rows['idCita'] ?>" id="frm-gestionCitas-<?= $rows['idCita'] ?>" action="" method="POST" onsubmit="return confirmacionAccion()">
                                    <tr>
                                        ...
                                        <td>
                                            <div class="columna-acciones">
                                                <button form="frm-gestionCitas-<?= $rows['idCita'] ?>" class="boton-icono" type="submit" name="opc" value="actualizarCita">
                                                ...
                                                <button form="frm-gestionCitas-<?= $rows['idCita'] ?>" class="boton-icono" type="submit" name="opc" value="eliminarCita">
