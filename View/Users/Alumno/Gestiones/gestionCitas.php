                            ...
                            <tbody class="table-group-divider">
                                ...
                                <form name="frm-gestionCitas-<?= $rows['idCita'] ?>" id="frm-gestionCitas-<?= $rows['idCita'] ?>" action="" method="POST" onsubmit="return confirmacionAccion()">
                                    <tr>
                                        ...
                                        <td> 
                                            <form name="frm-verMCAlumno-<?= $rows['idCita'] ?>" id="frm-verMCAlumno-<?= $rows['idCita'] ?>" action="index.php" method="POST">
                                                <button form="frm-verMCAlumno-<?= $rows['idCita'] ?>" type="submit" name="opc" value="vistaGestionMaterialCompartido">Ver</button>
                                                <input form="frm-verMCAlumno-<?= $rows['idCita'] ?>" type="hidden" name="idCita" value="<?= $rows['idCita'] ?>">
                                                <input form="frm-verMCAlumno-<?= $rows['idCita'] ?>" type="hidden" name="idProfesor" value="<?= $rows['ProfesorAsignatura_Profesor_matricula'] ?>">
                                            </form>
                                        </td>
