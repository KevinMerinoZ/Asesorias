...
<section class="body-reporteCCPC">
    <div class="container">
        <br>
        <div class="row d-flex justify-content-center">
            <div class="col-md-8 p-0 contenedor-accion">
                <h2>Reporte de Cantidad de Citas enviadas por Periodo Cuatrimestral</h2>
                ...
                <form name="frm-busquedaAlumno" action="" method="POST">
                    <div class="d-flex justify-content-between">
                        <label for="periodo" class="label-body" style="flex: 1; margin-right: 10px;">
                            ...
                            <select name="periodo" style="width: 300px; height: 25px;" required> 
                        ...
                        <label for="ano" class="label-body" style="flex: 1;">
                            <b>Año:</b> <br>
                            <input type="text" name="ano" style="width: 150px; height: 28px;" placeholder="Ingrese el año" maxlength="4" required> 
                        </label>
                    </div>
                    <br>
                    <br>
                    <div class="d-flex justify-content-center">
                    <button type="submit" name="opc" value="reporteCCPC" class="boton-primario" >Generar reporte</button>
                            </div>
                </form>
                <br>
                </div>
