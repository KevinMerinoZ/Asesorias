                            ...
                            <tbody class="table-group-divider">
                                ...
                                <form name="frm-gestionCitasRecibidas-<?= $rows['idCita'] ?>" id="frm-gestionCitasRecibidas-<?= $rows['idCita'] ?>" action="" method="POST" onsubmit="return confirmacionAccion()">
                                    <tr>
                                        ...
                                        <td>
                                            <div class="columna-acciones">
                                                <button form="frm-gestionCitasRecibidas-<?= $rows['idCita'] ?>" class="boton-icono" type="submit" name="opc" value="actualizarCitaRecibida">
                                                ...
                                                <button form="frm-gestionCitasRecibidas-<?= $rows['idCita'] ?>" class="boton-icono" type="submit" name="opc" value="eliminarCitaRecibida">
