                                    ...
                                    <tr>
                                        ...
                                        <td> 
                                            <select name="tipoMaterial">
                                                ...
                                                <?php }else if($tMaterial['categoria'] != $categoriaAnt){ ?>

                                                    <option value=<?= $tMaterial['idmaterial'] ?>><?= $tMaterial['categoria'] ?></option>

                                                <?php
                                                        }
                                                        $categoriaAnt = $tMaterial['categoria'];  
                                                    }
                                                }else{    ?>
                                        ...
                                        <td> 
                                            <div class="columna-acciones">
                                                <button form="frm-gestionMaterialCompartido-<?= $rows['idmaterialCompartido'] ?>" class="boton-icono" type="submit" name="opc" value="actualizarMaterialCompartido">
